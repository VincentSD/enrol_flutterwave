...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('enrol_flutterwave/pubKey',
                   get_string('clientkey', 'enrol_flutterwave'),
                   get_string('clientkey_desc', 'enrol_flutterwave'),''));
    $settings->add(new admin_setting_configtext('enrol_flutterwave/email',
                   get_string('email', 'enrol_flutterwave'),
                   get_string('email_desc', 'enrol_flutterwave'),''));
    ...
    $settings->add(new admin_setting_configtext('enrol_flutterwave/tcost',
                   get_string('tcost', 'enrol_flutterwave'), '', 0, PARAM_FLOAT, 4));
    ...
    $settings->add(new admin_setting_configduration('enrol_flutterwave/enrolperiod',
        get_string('enrolperiod', 'enrol_flutterwave'), 
        get_string('enrolperiod_desc', 'enrol_flutterwave'), 0));
}
