...
class enrol_flutterwave_plugin extends enrol_plugin {
    ...
    public function get_currencies() {
        $codes = array('GHS', 'USD', 'EUR', 'GBP', 'KES', 'NGN', 'RWF', 'SLL', 'TZS', 'UGX', 'XOF', 'ZAR','AUD', 'BRL', 'CAD', 'CHF', 'CZK', 'DKK',
                       'HKD', 'HUF', 'ILS', 'INR', 'JPY','MXN', 'MYR', 'NOK', 'NZD', 'PHP', 'PLN', 'RUB', 'SEK', 'SGD', 'THB', 'TRY', 'TWD');
        $currencies = array();
        foreach ($codes as $c) {
    ...
    public function enrol_page_hook(stdClass $instance) {
        ...
        $tcost = (float) $this->get_config('tcost');
